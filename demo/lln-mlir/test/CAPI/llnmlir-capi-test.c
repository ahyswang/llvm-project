//===- llnir-cap-demo.c - Simple demo of C-API -----------------------===//
//
...
int main(int argc, char **argv) {
  ...
  // This adds dozens of MB of binary size over just the llnir dialect.
  registerAllUpstreamDialects(ctx);
  mlirDialectHandleRegisterDialect(mlirGetDialectHandle__llnir__(), ctx);
