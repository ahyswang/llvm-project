...
func.func @test_op_mul_int8(%arg0: tensor<2x1x3x!quant_type>, %arg1: tensor<2x1x3x!quant_type>) -> tensor<2x1x3x!quant_type> {
    // CHECK: %{{.*}} = "standalone.mul"(%{{.*}}, %{{.*}}) : (tensor<2x1x3x!quant.uniform<i8:f32, 0.078431375324726104>>, tensor<2x1x3x!quant.uniform<i8:f32, 0.078431375324726104>>) -> tensor<2x1x3x!quant.uniform<i8:f32, 0.078431375324726104>>
