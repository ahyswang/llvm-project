...
#define CUSTOM_CALL_NAME_PREFIX "llnir."

constexpr llvm::StringRef getMatMulName() {
    return CUSTOM_CALL_NAME_PREFIX "matmul";
  }

constexpr llvm::StringRef getAddName() {
return CUSTOM_CALL_NAME_PREFIX "add";
}

void registerMatMulReifyReturnTypeShapes();
void registerAddReifyReturnTypeShapes();

// TODO
inline void registerAllLLNIRReifyReturnTypeShapes() {
//   registerDotReifyReturnTypeShapes();
//   registerDynamicStitchReifyReturnTypeShapes();
//   registerDynamicMaskStitchReifyReturnTypeShapes();
//   registerDynamicBroadcastInDimReifyReturnTypeShapes();
...
//   registerGeLUReifyReturnTypeShapes();
  // registerStridedSliceReifyReturnTypeShapes();
  registerMatMulReifyReturnTypeShapes();
  registerAddReifyReturnTypeShapes();
}
