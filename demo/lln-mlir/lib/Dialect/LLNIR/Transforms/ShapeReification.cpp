...
namespace mlir {
namespace llnir {
  #define GEN_PASS_DEF_SHAPEREIFICATION
...
namespace {
#if 1
LogicalResult reifyShapes_New(OpBuilder &builder, Operation *op,
...
struct ShapeReificationPass
    : public llnir::impl::ShapeReificationBase<ShapeReificationPass> {
  ...
  ShapeReificationPass()
    ...
    registerAllLLNIRReifyReturnTypeShapes();
  }
  ...
  void runOnOperation() override {
    ...
    cfg.setUseTopDownTraversal(false);
